...
const PAGES = [
  {
    ...
    desc: "开源的侧边栏 AI 助手。密钥只存在本机，没有账户、订阅和广告。",
    points: []
  },
  {
    art: "models",
    title: "先接一个模型",
    desc: "内置 OpenAI、Anthropic、Gemini、DeepSeek 和本地 Ollama 预设，填入 API Key 即可开始。",
    points: [
      "请求从你的浏览器直连服务商，不经过第三方",
  ...
  },
  {
    art: "page",
    title: "它读懂你正在看的页面",
    desc: "提问时可以自动附带当前标签页的正文，也能把 PDF、图片拖进来一起问。",
    points: [
      "勾选「附带页面」，针对当前页直接问答",
      "PDF 走内置阅读器解析，内容不出本机",
      "可以同时关联多个标签页一起分析"
  ...
  },
  {
    art: "shield",
    title: "技能和权限都由你掌控",
    desc: "用 / 调用自定义技能；所有敏感能力默认关闭或先征求同意。",
    points: [
      "在 设置 → 技能 创建自己的斜杠命令",
      "AI 点击或填写网页前，会先弹窗问你",
      "不需要的功能可以在设置里逐项关掉"
  ...
  },
  {
    art: "done",
    title: "准备好了",
    desc: "点击工具栏图标，或在任意页面按 Alt+Q，开始第一段对话。",
    points: []
  }
];
