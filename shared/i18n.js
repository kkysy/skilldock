const COPY = {
  en: {
    ...
    "上下文限制": "Context limit", "按估算 token 计算。超过限制时，较早对话会自动压缩为摘要；原始聊天记录会保留在本地。": "Measured in estimated tokens. When the limit is exceeded, earlier chat is summarized automatically; the original local chat history is retained.", "上下文限制（token）": "Context limit (tokens)",
    ...
    "新建技能": "New skill", "技能说明 / 系统指令": "Skill instructions / system prompt", "支持 Markdown，适合编写较长的技能规则、步骤和示例。": "Markdown is supported for longer skill rules, steps, and examples.", "技能说明视图": "Skill instruction view", "编辑": "Edit", "预览": "Preview", "还没有技能说明": "No skill instructions yet.", "可读当前页": "Can read current page", "可用浏览器操作": "Can use browser control", "可用网络搜索": "Can use web search", "保存技能": "Save skill",
    ...
    "正在工作": "Working", "正在压缩上下文": "Compressing context", "上下文": "Context", "上下文占用": "Context usage", "估算值，超过限制时会自动压缩较早对话。": "Estimated. Earlier chat is compressed automatically when the limit is exceeded.",
