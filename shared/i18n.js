const COPY = {
  en: {
    ...
    "系统提示词": "System prompt", "附加在每次对话开头的全局指令": "Global instruction prepended to every conversation.", "保存常规设置": "Save general settings", "已保存": "Saved",
    ...
    "准备好开始对话": "Ready to chat", "选择模型": "Choose model", "关闭模型选择": "Close model picker", "选择技能": "Choose skill", "技能": "Skill",
    ...
    "暂无模型，请在设置中添加或拉取": "No models yet. Add or fetch them in Settings.", "不使用技能": "No skill", "直接与模型对话": "Chat with the model directly", "你": "You", "工具": "Tool", "已复制": "Copied", "复制": "Copy", "复制失败": "Copy failed", "编辑": "Edit", "重生成": "Regenerate", "导出此回答为 Markdown": "Export this answer as Markdown", "正在编辑上一条消息": "Editing the previous message", "对话": "Chat", "未命名": "Untitled", "导出": "Export", "删除": "Delete", "还没有对话": "No conversations yet", "回到顶部": "Back to top", "过程": "Process",
